...
import { VertexNormalsHelper } from "../../tools/jsm/helpers/VertexNormalsHelper.js";
...
function SidebarGeometry(editor) {
  ...
  /*
	...
	objectActions.onChange( function ( event ) {
		...
		let object = editor.selectionHelper.selectedObject[0];
  ...
  signals.hierarchyChange.add(getSelectedObj);
